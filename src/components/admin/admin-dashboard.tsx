...
export async function AdminDashboard({ assignStyleAction, deactivateCustomerSettingAction, deactivateProductSettingAction, deactivateWarehousesAction, error, saveCustomerSettingAction, saveFreightLevelAction, saveProductSettingAction, selectedTab }: { assignStyleAction: (formData: FormData) => Promise<void>; deactivateCustomerSettingAction: (formData: FormData) => Promise<void>; deactivateProductSettingAction: (formData: FormData) => Promise<void>; deactivateWarehousesAction: (formData: FormData) => Promise<void>; error?: string; saveCustomerSettingAction: (formData: FormData) => Promise<void>; saveFreightLevelAction: (formData: FormData) => Promise<void>; saveProductSettingAction: (formData: FormData) => Promise<void>; selectedTab?: string }) {
  ...
  return <section className="dashboard-panel">
    ...
    <section className="tab-strip" aria-label="Administration sections">
      ...
      <Link aria-current={activeTab === "freight" ? "page" : undefined} href="/?module=admin&admin_tab=freight">Freight Levels</Link>
    </section>
    <section className="section-stack">
      ...
      <article className={activeTab === "freight" ? "data-section tab-panel--flush" : "data-section tab-panel-hidden"}><FreightLevelManager accountTypes={customerAccountTypesResult.data ?? []} error={error} freightLevels={freightLevelsResult.data ?? []} groups={freightLevelGroupsResult.data ?? []} saveAction={saveFreightLevelAction} /></article>
