  ...
  return <section className="dashboard-panel">
    ...
    <section className="section-stack">
      ...
      <article className={activeTab === "freight" ? "data-section tab-panel--flush" : "data-section tab-panel-hidden"}>
        ...
        {selectedFreightTab === "carriers" ? <FreightCarrierManager carriers={freightCarriersResult.data ?? []} error={error} saveAction={saveFreightCarrierAction} /> : <FreightLevelManager accountTypes={customerAccountTypesResult.data ?? []} error={error} freightLevels={freightLevelsResult.data ?? []} groups={freightLevelGroupsResult.data ?? []} saveAction={saveFreightLevelAction} />}
      </article>
